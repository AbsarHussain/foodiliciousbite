...
<script>
  ...
  gtag('config', 'UA-69616744-3');
	...
	<title>Foodiliciousbite - Find Delicious Variety of Home Made Food All Around Pakistan</title>
	<meta charset="UTF-8">
    ...
    <footer class="ftco-footer ftco-bg-dark ftco-section">
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-6 col-lg-3">
             <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Terms Of Use</h2>
