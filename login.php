...
<head>
   <title>Foodiliciousbite - Taste and Health jumping into the mouth</title>
    ...
    <link rel="stylesheet" href="kusina/css/open-siiconic-bootstrap.min.css">
 ...
 <div class="container" style="margin-top:100px;">
       ...
       <div class="col-md-6">
                  <div class="form-group">
                    	   ...
                    	   <input class="form-control form-control-lg"  type="text" name="user_email" placeholder="Enter your Email Address" required>
  	               
                  </div>
                </div>       
                <div class="col-md-6">
                  <div class="form-group">
                    	                   <!--<input id="emailto" placeholder="Email Address" class="form-control">-->
	...
	<button  class="btn btn-block btn-lg btn-primary" type="search" name= "submit-login"  >Login </button>
	</div>
	</div>
</form>
...
<!--<form action="processlogin.php" method="post">-->
<!--    <input type="text" name="user_email" placeholder="Enter your Email Address" required>-->
<!--    <input type="password" name="password" placeholder="Enter your password" required>-->
    
<!--	<button  type="search" name= "submit-login"  ><b>SUBMIT </b></button>-->
<!--</form>-->
