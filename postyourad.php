...
?>
<?php
 $query_shops = "select * from t_shops where user_id =".$user_id." ";
  $result_shops = mysqli_query($db, $query_shops);
  if(mysqli_num_rows($result_shops) < 1)
  {
	echo "<script>
			alert('You need to create one kitchen Or Restaurant, then come back to this page and Attach Products to That Kitchen/Restaurant');
			window.location.href='createshoploc.php';
			</script>";
...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item active"><a href="postyourad.php" class="nav-link">Sell My Dish</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
             <h1 class="mb-2 bread">Sell My Dish</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Sell My Dish <i class="ion-ios-arrow-forward"></i></span></p>
	...
	<div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
				<input type="text" placeholder="Servings" name="serving"  class="form-control" required>
				</div>
				</div>
	  ...
	  <option value="" disabled selected>Choose A Delivery Scope</option>
	  <option value="4">All Over Pakistan</option>
	  <option value="3">All Areas of City</option>
<option value="2">Some Areas of City</option>
