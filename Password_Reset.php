...
<body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Welcome On Board <i class="ion-ios-arrow-forward"></i></span></p>
    ...
    <div class="container" style="margin-top:100px;">
        <div class="row justify-content-center">
            <div class="col-md-6 col-md-offset-3" align="center">
                ...
                <input type="button" onclick="sendEmail(); " value="Send Me Email" class="btn btn-primary">
				<div class="col-md-6">
                  <div class="form-group">
				...
				<div class="col-md-6">
                  <div class="form-group">
					  <p>Check You Email For Password</p>
	...
	<script type="text/javascript">
        ...
        function sendEmail() {
            ...
            if (isNotEmpty(emailto) ) {
                $.ajax({
                   url: 'sendpasswordresetemail.php',
                   method: 'POST',
                   dataType: 'json',
                   data: {
