...
$_SESSION["url"] = $_SERVER["REQUEST_URI"]."";
  ...
  // If upload button is clicked ...
	 ...
	 S.shop_name from products P left join t_category C on P.category=C.category_id 
	 JOIN t_shops S on P.shop_id=S.shop_id 
	 where P.user_id = '$user_id' and P.status='NOT DELETED'";
	 
	 
	 //ducts] P JOIN t_locations L ON P.product_id=L.product_id JOIN L.delivery_scope_id=D.delivery_scope_id  D.delivery_scope_rank>='%$search_delivery_scope_rank%'  AND L.city like '%$search_city%' AND L.town like '%$e_location%'AND (P.title like '%$search_title%' OR details like '%$search_title%') AND delivery_scope";}
   ...
   //echo "<div id='restaurant-menu-background'>";		
    ...
    // echo "<div class='post'>"  ;      
	 //echo "<div class='menu-section' >";     
        ...
        echo "<img   id='rounded_corners' style=object-fit: contain' src='img/product_images/".$thumbnail."'>";
...
// 		$details=substr($details, 0, 150);
		...
		echo "<a href='deleteproduct.php?id=".$product_id."-".$shop_id."-".$user_id."'>Delete Product</a>";
		echo "</div>";
