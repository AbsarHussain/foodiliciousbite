...
include('config.php');	
  ...
  $_SESSION["url"] = $_SERVER["REQUEST_URI"]."";
   ...
   if (isset($_POST['editshop'])) {
	...
	$user_lat=mysqli_real_escape_string($db, $_POST['user_lat']);
 	$user_long = mysqli_real_escape_string($db, $_POST['user_long']);   
	$query_my_shops = "select S.shop_name,S.shop_note,S.shop_id,S.code,S.shop_town,
		S.shop_currency,S.shop_contact,SIM.image_name as thumbnail,S.shop_whatsapp
		from t_shops S 
		JOIN t_images SIM ON SIM.shop_id=S.shop_id
        where S.user_id = '$user_id' and S.shop_id='$shop_id' ";
...
<html lang="en">
  ...
  <body>
    ...
    while ($row = mysqli_fetch_array($result_my_shops)) {
		...
		$shop_whatsapp=$row['shop_whatsapp'];
	$code=$row['code'];}
?>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb">
          ...
          <div class="col-md-7 ftco-animate makereservation p-4 p-md-5">
			 ...
			 <form method="POST" action="saveeditedshop.php" enctype="multipart/form-data">
              <div class="row">
			  <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="shop_name" value="<?php echo $shop_name;?>" required>
                  </div>
                </div>
				 <div class="col-md-12">
                  <div class="form-group">
				...
				<input type="text" class="form-control" value="<?php echo $shop_note;?>" name="shop_note" >
                </div>
				</div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                  <input type="text" class="form-control" value="<?php echo $shop_town;?>" name="shop_town" required></div>
                </div>
				<div class="col-md-6">
                  <div class="form-group">
            			
				<input type="text" class="form-control" value="<?php echo $shop_contact;?>" name="shop_contact" required>
			    </div></div>
				<div class="col-md-6">
                  <div class="form-group">
            			
				<input type="text" class="form-control" value="<?php echo $shop_whatsapp;?>" name="shop_contact" required>
			    </div></div>
						<div class="col-md-12">
                  <div class="form-group">
  ...
  <datalist id="browsers">
	...
	echo '<option value="'.$row['city_name'].'/'.$row['country_name'].'"></option>';} ?>
				...
				<select name="shop_location_status"  class="form-control" required>
				  ...
				  <option  class="form-control" value="0">Keep it Same as before /I will Update Later </option>	
                ...
                <div class="col-md-12 mt-3">
                  <div class="form-group">
					...
					<input type="submit" name="saveeditshop" onclick="processingform();"  value="Create Restaurant" class="btn-primaryc plr-25">
